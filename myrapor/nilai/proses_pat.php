...
$sheet->setCellValue('A1', "INPUT NILAI PAT"); 
...
header("Content-Disposition: attachment; filename=FORMAT_NILAI_PAT_SEMESTER $mpl[kode] $semester $tapel.xlsx");
