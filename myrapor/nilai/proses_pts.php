...
$sheet->setCellValue('A1', "INPUT NILAI PTS"); 
...
$i = 5;
$no = 1;
$stmt = $pdo->prepare("SELECT id_siswa, nis, nama, kelas FROM siswa WHERE kelas = ?");
$stmt->execute([$kelas]);
...
header("Content-Disposition: attachment; filename=FORMAT_NILAI_PTS_SEMESTER $mpl[kode] $semester $tapel.xlsx");
