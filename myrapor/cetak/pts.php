       ...
       <div class="col-md-8">
         <div class="card">
           <div class="card-header">
               <h5 class="card-title">CETAK RAPOR PTS <span class="badge badge-success"><?= $semester ?></span></h5>
				</div>	  
             <div class="card-body">
						...
						try {
							...
							foreach ($siswaList as $data) {
								...
								<tr style="vertical-align:middle;">
									...
									<td>
										<a href="cetak/print_cover.php?ids=<?= $data['id_siswa'] ?>&k=PTS" target="_blank" class="btn btn-sm btn-primary">
											<i class="material-icons">print</i>
										</a>
										<a href="cetak/rapor_pts.php?ids=<?= $data['id_siswa'] ?>" target="_blank" class="btn btn-sm btn-warning">
											<i class="material-icons">print</i>
										</a>
									</td>
								</tr>
...
<script type="text/javascript">
	...
	var k = $('#kelas').val();
	location.replace("?pg=<?= enkripsi('cetakpts') ?>&k=" + k);
	}); 
</script>						
<?php endif ?>
