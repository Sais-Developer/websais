...
$stmt = $pdo->prepare("SELECT * FROM nilai_rapor WHERE semester = :semester AND tapel = :tapel");
$stmt->execute([
    ':semester' => $semester,
    ':tapel'   => $tp
]);
...
$stmt2 = $pdo->prepare("SELECT * FROM kokurikuler WHERE smt = :smt AND tapel = :tapel");
$stmt2->execute([
    ':smt' => $semester,
    ':tapel'   => $tp
]);
				...
				<div class="card-body">
					<div class="widget-stats-container d-flex">
						...
						<div class="widget-stats-content flex-fill">
							<span class="widget-stats-title">Nilai Rapor</span>
							<span class="widget-stats-amount"><?= $nr ?></span>
		...
		<div class="card widget widget-stats">
			<div class="card-body">
				<div class="widget-stats-container d-flex">
					...
					<div class="widget-stats-content flex-fill">
						<span class="widget-stats-title">Kokurikuler</span>
...
$("#confirm").click(function(){
    Swal.fire({
        ...
        text: "Database Presensi akan direset",
        icon: 'warning',
        width: '320px',
