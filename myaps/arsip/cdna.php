       ...
       <div class="col-md-8">
         <div class="card">
           <div class="card-header">
               <h5 class="card-title">CETAK DNA <span class="badge badge-success"><?= $semester ?></span></h5>
				</div>	  
             <div class="card-body">
			     ...
			     <div class="col-md-12 mb-1">
					<label class="bold">Kelas</label>
						...
						<div class="widget-payment-request-actions m-t-lg d-flex mb-4">
							...
							<?php else: ?>
                              <div class="widget-payment-request-actions m-t-lg d-flex mb-4">
                            <a href="cetak/cetakdna.php?k=<?= $kelas ?>&kt=<?= $ket ?>" target="_blank" class="btn btn-primary flex-grow-1 m-l-xxs">CETAK DNA</a>				
                             </div>
							 <?php endif; ?>							
								<div class="d-flex justify-content-between mb-2">
									<div class="text-center">
										...
										var k = $('#kelas').val();
										var kt = $('#ket').val();
										location.replace("?pg=<?= enkripsi('cetakdna') ?>&k=" + k + "&kt=" + kt);
										}); 
									</script>
									 </div>
					            </div>
