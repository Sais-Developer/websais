...
<div class="card">
  <div class="card-body">
   ...
   <form id="formserver">
        <label class="bold">Server Sinkron</label>			            
		<div class="input-group mb-3">
		  <input type='text' name='server' value="<?= $setting['server'] ?>" class='form-control' required >
...
<script>
    ...
    <h3>Sinkronisasi Data Master</h3>
    <form id="formsinkron">
	   <input type="hidden" name="tokenapi" value="<?= $setting['token_api'] ?>" >
        ...
        <div class="checkbox-group">
            <label>
                <input type="checkbox" name="data[]" value="siswa">
                <span class="checkmark"></span>
                Data Siswa
            </label>
			<label>
                <input type="checkbox" name="data[]" value="fotosiswa">
                <span class="checkmark"></span>
                Foto Siswa
            </label>
            <label>
                <input type="checkbox" name="data[]" value="guru">
                <span class="checkmark"></span>
                Data Pegawai
            </label>
			<label>
                <input type="checkbox" name="data[]" value="fotoguru">
                <span class="checkmark"></span>
                Foto Pegawai
            </label>
            <label>
                <input type="checkbox" name="data[]" value="mapel">
                <span class="checkmark"></span>
                Data Mata Pelajaran
            </label>
            <label>
                <input type="checkbox" name="data[]" value="kelas">
                <span class="checkmark"></span>
                Data Kelas
            </label>
        </div>
		...
		<div class="card-body">
			<ul class="widget-list-content list-unstyled">
				  <?php
					...
					$stmt = $pdo->prepare("SELECT * FROM sinkron WHERE id BETWEEN 1 AND 4");
					$stmt->execute();
                    ...
                    <li class="widget-list-item widget-list-item-blue">
						...
						<span class="widget-list-item-transaction-amount-positive"><?= $jumlah ?> Data</span>
					</li>
					<?php
					$jumsis = count(array_filter(
						glob('../images/fotosiswa/*'),
						function($f){
							return basename($f) !== '.htaccess';
						}
						));
                    ...
                    <li class="widget-list-item widget-list-item-blue">
						...
						<span class="widget-list-item-transaction-amount-positive"><?= $jumsis ?> Data</span>
					</li>
                     </ul>
				</div>
			</div>
