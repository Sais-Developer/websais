...
<head>
    ...
    <style>
        ...
        .kartu { position: relative; width: 208px; height: 328px; margin-bottom:5px; }
        .qr-code { position: absolute; top: 10px; right: 10px; width:50px; height:50px; }
        .text-kartu { position: absolute; top: 100px; left:10px; right:10px; font-size: 9px; line-height: 1.1; }
        .ttd { position: absolute; bottom: 10px; left:105px; width:70px; }
        .stempel { position: absolute; bottom: 10px; left:115px; width:60px; }
        .footer { position: absolute; bottom: 20px; left:110px; font-size: 8px; line-height:1.1; }
    </style>
</head>
<body>
...
<td style="width:50%; padding:0; margin:0;">
    <div class="kartu">
        <img src="<?= $baseurl ?>/mypres/kartu/2.png" style="width:100%; height:100%;">
       
        <div class="text-kartu">
            <b>KARTU PEGAWAI DAN PRESENSI</b><br>
            * Kartu ini berlaku selama menjadi pegawai<br>
...
$dompdf->render();
$dompdf->stream("KARPEG BLK.pdf", ["Attachment" => false]);
exit(0);
?>
