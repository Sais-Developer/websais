 ...
 <?php if ($ac == '') : ?>
  <div class="row">
     <div class="col-md-8">
		...
		<div class="card-body"> 
					<form action="kartu/siswa1.php" target="_blank" method="POST" class="form-horizontal form-label-left">
		...
		<div class="card-body"> 
					...
					<form action="kartu/siswa2.php" target="_blank" method="POST" class="form-horizontal form-label-left">
