...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <div class="card-header"><h5>DATA FACE RECOGNITION SISWA</h5></div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" id="datatable1">
                       ...
                       <?php
						$no = 0;
							$stmt = $pdo->prepare("SELECT * FROM datareg WHERE folder <> '' AND level = 'siswa' ORDER BY id DESC");
							$stmt->execute();
...
$('#kelas').change(function(){
    var k = $('#kelas').val();
    location.replace("?pg=<?= enkripsi('rfsis') ?>&ac=siswa&k=" + k );
});
</script>
				  ...
				  <div id="parent2" >
					...
					<div id="reg_disp" style="display: none;">
						<div class="col-md-12">
							...
							<div id="log_disp">
						<div id="logname" style="font-size: 35px; font-weight: bold; margin-left: 40px; width: 570px; white-space: pre-wrap; text-align: center;"></div>
					 </div>
				  </div>
			   </div>
			</div>
