                    ...
                    <div class="container-fluid">
                        <div class="navbar-nav" id="navbarNav">
                            <ul class="navbar-nav">
								...
								<li class="nav-item hidden-on-mobile">
                                  <a class="nav-link" href="?pg=<?= enkripsi('sinkron') ?>"><i class="material-icons">sync</i> Sync Presensi</a> 
                                </li>
								<li class="nav-item hidden-on-mobile">
								<?php if($setting['mesin']=='5'): ?>
                                  <a class="nav-link" href="<?= $baseurl ?>/lives" target="_blank"><i class="material-icons">wifi</i> Live Presensi</a> 
								<?php else: ?>
								 <a class="nav-link" href="<?= $baseurl ?>/live" target="_blank"><i class="material-icons">wifi</i> Live Presensi</a> 
								<?php endif; ?>
                                </li>
								<?php endif; ?>
                            </ul>
