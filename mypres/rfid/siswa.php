	...
	<div class="text-muted"><?= $setting['sekolah'] ?></div>
	   ...
	   <div class="widget-payment-request-info m-t-md">
		   <div class="d-grid gap-2 mb-4">
			  <a href="?pg=<?= enkripsi('regsis') ?>&ac=<?= enkripsi('siswa') ?>" class="btn btn-primary"> Registrasi Siswa</a>
			 </div>												
			 <div class="mb-4">
				   ...
				   <thead>
					...
					<tbody>
						...
						<tr>
							...
							<td>                                            
								<a href="?pg=<?= enkripsi('regsis') ?>&ac=<?= enkripsi('siswa') ?>&ids=<?= htmlspecialchars($data['id_siswa'] ?? '', ENT_QUOTES) ?>">
									<button class='btn btn-sm btn-success' data-bs-toggle="tooltip" data-bs-placement="top" title="Registrasi RFID">
...
$('#formkartu').submit(function(e){
	...
	$.ajax(
	{
		...
		setTimeout(function()
			{
			window.location.replace('?pg=<?= enkripsi("regsis") ?>&ac=<?= enkripsi("siswa") ?>');
		}, 200);
