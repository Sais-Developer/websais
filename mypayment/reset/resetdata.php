...
$trx   = countRows($db, "trx_bayar");
$lainnya   = countRows($db, "pay_lainnya");
?>
				...
				<div class="card-body">
					<div class="widget-stats-container d-flex">
						...
						<div class="widget-stats-content flex-fill">
							<span class="widget-stats-title">Transaksi</span>
							<span class="widget-stats-amount"><?= $trx ?></span>
		...
		<div class="card widget widget-stats">
			<div class="card-body">
				<div class="widget-stats-container d-flex">
					...
					<div class="widget-stats-content flex-fill">
						<span class="widget-stats-title">Payment Pegawai</span>
						<span class="widget-stats-amount"><?= $lainnya ?></span>
						<span class="widget-stats-info"></span>
					</div>
...
$("#confirm").click(function(){
    Swal.fire({
        ...
        text: "Database Payment akan direset",
        icon: 'warning',
        width: '320px',
