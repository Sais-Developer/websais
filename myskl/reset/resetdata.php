...
$agenda   = countRows($db, "nilai_skl");
$stmt = $pdo->prepare("SELECT COUNT(*) AS jumlah_siswa FROM siswa WHERE ket = :ket");
    $stmt->execute(['ket' => 1]);
    $lulus = $stmt->fetch(PDO::FETCH_ASSOC);
				...
				<div class="card-body">
					<div class="widget-stats-container d-flex">
						...
						<div class="widget-stats-content flex-fill">
							<span class="widget-stats-title">Nilai SKL</span>
			...
			<div class="card-body">
				<div class="widget-stats-container d-flex">
					...
					<div class="widget-stats-content flex-fill">
						...
						<span class="widget-stats-amount"><?= $lulus['jumlah_siswa'] ?></span>
						<span class="widget-stats-info"></span>
					</div>
...
$("#confirm").click(function(){
    Swal.fire({
        ...
        text: "Database SKL akan direset",
        icon: 'warning',
        width: '320px',
