...
$nilah = countRows($db, "nilai_harian");
		...
		<div class="card widget widget-stats">
			<div class="card-body">
				<div class="widget-stats-container d-flex">
					...
					<div class="widget-stats-content flex-fill">
						<span class="widget-stats-title">Penilaian Harian</span>
						<span class="widget-stats-amount"><?= $nilah ?></span>
						<span class="widget-stats-info"></span>
					</div>
...
$("#confirm").click(function(){
    Swal.fire({
        ...
        text: "Database KBM akan direset",
        icon: 'warning',
        width: '320px',
