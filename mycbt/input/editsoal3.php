...
$stmtCount = $pdo->prepare("
    ...
    FROM soal 
    WHERE id_bank = :id_bank AND nomor = :nomor AND jenis = 2
");
			...
			<div class="col-md-6">
		      <div class="card">
				<div class="card-header">
			       <h5 class="card-title">SOAL PG MULTI CHOICE</h5>
                   </div>
              <div class="card-body">
                   ...
                   <div class="tab-content" id="pills-tabContent">
                       <div class="tab-pane fade active show" id="pills-A" role="tabpanel" aria-labelledby="pills-A-tab">
							...
							<a class="btn btn-sm btn-outline-secondary">JAWABAN A</a> 
								<label class="checkbox d-flex align-items-center" style="margin-top:-25px">
								<input class='hidden radio-label' type='checkbox' <?php in_array ('A', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='A' />
					...
					<div class="tab-pane fade" id="pills-B" role="tabpanel" aria-labelledby="pills-B-tab">
                        <div class="d-flex justify-content-between align-items-center mb-2">
							<a class="btn btn-sm btn-outline-secondary">JAWABAN B</a> 
								<label class="checkbox d-flex align-items-center" style="margin-top:-25px">
									<input class='hidden radio-label' type='checkbox' <?php in_array ('B', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='B' />
									<span class="check"></span></label>
								</div>
							<div class='form-group'>
					...
					<div class="tab-pane fade" id="pills-C" role="tabpanel" aria-labelledby="pills-C-tab">
                        <div class="d-flex justify-content-between align-items-center mb-2">
							<a class="btn btn-sm btn-outline-secondary">JAWABAN C</a> 
								<label class="checkbox d-flex align-items-center" style="margin-top:-25px">
									<input class='hidden radio-label' type='checkbox' <?php in_array ('C', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='C' />
								<span class="check"></span></label>
							</div>
						<div class='form-group'>
						...
						<div class="tab-pane fade" id="pills-D" role="tabpanel" aria-labelledby="pills-D-tab">
							<div class="d-flex justify-content-between align-items-center mb-2">
								<a class="btn btn-sm btn-outline-secondary">JAWABAN D</a>   
									<label class="checkbox d-flex align-items-center" style="margin-top:-25px">
										<input class='hidden radio-label' type='checkbox' <?php in_array ('D', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='D' />
									<span class="check"></span></label>
								</div>
						<div class='form-group'>
					 ...
					 <div class="tab-pane fade" id="pills-E" role="tabpanel" aria-labelledby="pills-E-tab">
                        <div class="d-flex justify-content-between align-items-center mb-2">
							<a class="btn btn-sm btn-outline-secondary">JAWABAN E</a>   
								<label class="checkbox d-flex align-items-center" style="margin-top:-25px">
									<input class='hidden radio-label' type='checkbox' <?php in_array ('E', $checked) ? print 'checked' : ''; ?> name='jawaban[]' value='E' />
								<span class="check"></span></label>
							</div>
						<div class='form-group'>
