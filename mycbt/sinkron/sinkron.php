...
<div class="card">
  <div class="card-body">
   <div class="text-center mb-2">
    ...
    <h3>Sinkronisasi Data Asesmen</h3>
    <form id="formsinkron">
	   <input type="hidden" name="tokenapi" value="<?= $setting['token_api'] ?>" >
        ...
        <div class="checkbox-group">
            <label>
                <input type="checkbox" name="data[]" value="bank">
                <span class="checkmark"></span>
               Data Bank Soal
            </label>
			<label>
                <input type="checkbox" name="data[]" value="soal">
                <span class="checkmark"></span>
                Data Soal
            </label>
            <label>
                <input type="checkbox" name="data[]" value="filesoal">
                <span class="checkmark"></span>
                Data File Soal
            </label>
			<label>
                <input type="checkbox" name="data[]" value="jenis">
                <span class="checkmark"></span>
                Jenis Asesmen
            </label>
            <label>
                <input type="checkbox" name="data[]" value="jadwal">
                <span class="checkmark"></span>
                Jadwal Asesmen
            </label>
		...
		<div class="card-body">
			<ul class="widget-list-content list-unstyled">
				  <?php
					...
					$stmt = $pdo->prepare("SELECT * FROM sinkron WHERE id BETWEEN 5 AND 8");
					$stmt->execute();
