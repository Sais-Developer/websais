<?php
require("../../konek/koneksi.php");   // Pastikan koneksi PDO tersedia di sini
require("../../konek/function.php");
require("../../konek/crud.php");
?>
<link rel='stylesheet' href='<?= $baseurl ?>/vendor/css/bootstrap.min.css' />
<style type="text/css">
    body {
        color: #000;
        width: 100%;
    ...
    * { box-sizing: border-box; -moz-box-sizing: border-box; }
    ...
    @media print {
        ...
        .page { margin: 10mm; border: initial; border-radius: initial; width: initial; min-height: initial; box-shadow: initial; background: initial; page-break-after: always; }
        .footer { bottom: .7cm; left: .7cm; right: .7cm }
    }
</style>
...
$sqlx = $pdo->prepare("SELECT * FROM berita a 
    LEFT JOIN banksoal b ON a.id_bank=b.id_bank 
    LEFT JOIN mapel c ON b.idmapel=c.id 
    WHERE a.id_berita=:id_berita");
$sqlx->execute(['id_berita' => $idujian]);
$ujian = $sqlx->fetch(PDO::FETCH_ASSOC);
    ...
    <table border='0' width='100%'>
        <tr>
            ...
            <td colspan='2' style="text-align:center">
                <span style="font-size:110%"><b>BERITA ACARA PELAKSANAAN</b></span>
            </td>
            <td rowspan='7' style="width:'120'; text-align:center">
                <img src="<?= $baseurl; ?>/images/<?= $setting['logo'] ?>" width='80px'>
            </td>
        </tr>
        <tr>
            <td colspan='2' style="text-align:center">
                <span style="font-size:110%"><b><?= strtoupper($setting['jenis_ujian']) ?></b></span>
            </td>
        </tr>
        <tr>
            <td colspan='2' style="text-align:center">
                <span style="font-size:110%"><b>TAHUN PELAJARAN <?= $ajaran ?></b></span>
            </td>
        </tr>
    </table>
    <br>
