...
$jurnal   = countRows($db, "pkl_jurnal");
$absen   = countRows($db, "pkl_presensi");
?>
				...
				<div class="card-body">
					<div class="widget-stats-container d-flex">
						...
						<div class="widget-stats-content flex-fill">
							<span class="widget-stats-title">Jurnal Prakerin</span>
		...
		<div class="card widget widget-stats">
			<div class="card-body">
				<div class="widget-stats-container d-flex">
					...
					<div class="widget-stats-content flex-fill">
						<span class="widget-stats-title">Presensi Prakerin</span>
...
$("#confirm").click(function(){
    Swal.fire({
        ...
        text: "Database Prakerin akan direset",
        icon: 'warning',
        width: '320px',
